...
public class SmsUtil {
    ...
    static  String accessKeyId = "LTAI4FvhPtBkT3EkEWiaUUaU"; //你保存的accessKeyId值
    static  String accessKeySecret = "5q6bkpDyJlGYo7eoO8OIAw55Ln6oI3";//accessKeySecret值
    ...
    public static String sendSms(String Numbers,String code) throws ClientException{
        ...
        request.setSignName("easyBuy网");//必填:短信签名-可在短信控制台中找到
        request.setTemplateCode("SMS_185846493"); //必填:短信模板-可在短信控制台中找到
   ...
   /* public static void main(String[] args) throws ClientException {
        SmsUtil.sendSms("15387794561","999999");
    }
*/
}
